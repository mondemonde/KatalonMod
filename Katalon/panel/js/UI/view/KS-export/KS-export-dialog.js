...
class KSExportDialog extends GenericDialog {
  constructor() {
    ...
    <div class="content">
        ...
        <div>
            <select style="width: 300px;margin-bottom: 16px;" id="export-to-KS-select-script-language" class="select-script-language">
           ...
           <input id="export-to-KS-driver-path" type="text" placeholder="Input the path to WebDriver" disabled/>
