...
import { getSelectedCase, setSelectedCase, setDynamicSelectedCase } from "../../../../../UI/view/testcase-grid/selected-case.js";
...
function executionLoop() {
  ...
  if (commandElements[currentPlayingCommandIndex + 1].getElementsByTagName("td")[1].classList.contains("break") &&
    !commandElements[currentPlayingCommandIndex + 1].getElementsByTagName("td")[1].classList.contains("stopping")) {
    commandElements[currentPlayingCommandIndex + 1].getElementsByTagName("td")[1].classList.add("stopping");
  ...
  if (commandElements[currentPlayingCommandIndex].getElementsByTagName("td")[1].classList.contains("stopping")) {
    commandElements[currentPlayingCommandIndex].getElementsByTagName("td")[1].classList.remove("stopping");
  }
...
async function executionDialog() {
  ...
  /*** If user's preference is stop or no configuration exists,
   * continue executing commands */
  if (testExecution?.continueExecution == undefined
    || testExecution.continueExecution)
    return true;
