...
function addContextMenuButton(id, node, menu, type) {
    ...
    buttonWrapper.innerHTML = '<button class="btn-more tooltip"><img src="/katalon/images/SVG/more-icon.svg" alt="More"><span class="tooltiptext" style="width: 40px;margin-left: -15px;">More</span></button>';
