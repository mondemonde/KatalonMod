const sampleData = [{
        testSuiteName: "Submission1",
        projectName: "Generic Submission",
        description: "Create record and ready for submission",
...
<table cellpadding="1" cellspacing="1" border="1">
  ...
  <tr><td>click</td><td>id=submit<datalist><option>id=submit</option><option>//button[@id='submit']</option><option>//form[@id='infoForm']/div[13]/div/button</option><option>//button</option><option>css=#submit</option></datalist></td><td></td>
    ...
    {
        testSuiteName: "Capture screenshots2",
        projectName: "Capture screenshots2",
...
<table cellpadding="1" cellspacing="1" border="1">
  ...
  <tr><td>captureEntirePageScreenshot</td><td>after-adding-comment<datalist><option>after-adding-comment</option></datalist></td><td></td>
    ...
    {
        testSuiteName: "Working with variables2",
        projectName: "Combine values2",
    ...
    {
        testSuiteName: "Manipulate page’s Javascript variables2",
        projectName: "Execute Javascript2",
    ...
    {
        testSuiteName: "if…elseif…else…endif2",
...
<table cellpadding="1" cellspacing="1" border="1">
  ...
  <tr><td>endIf</td><td><datalist><option></option></datalist></td><td></td>
    ...
    {
        testSuiteName: "while…endwhile2",
        projectName: "Repeat similar actions2",
    ...
    {
        testSuiteName: "Nested loops2",
        projectName: "Repeat actions on similar pages2",
    ...
    {
        testSuiteName: "gotoIf…gotoLabel…label2",
        projectName: "Reuse actions in your automation scripts2",
    ...
    {
        testSuiteName: "Test Data2",
        projectName: "Fill a form with data from CSV file with Sample Test Data 2",
    ...
    {
        testSuiteName: "Verify vs Assert2",
        projectName: "Stop when field values are unexpected2",
    ...
    {
        testSuiteName: "waitFor…2",
        projectName: "Wait patiently2",
    ...
    {
        testSuiteName: "waitFor…wisthCustomTimeout2",
        projectName: "Wait impatiently2",
    ...
    {
        testSuiteName: "storeCSV sample2",
        projectName: "Read and use values from a CSV file with Sample Test Data.2",
    ...
    {
        testSuiteName: "Upload a file with drag and drop2",
        projectName: "Upload a file with drag and drop.2",
    ...
    {
        testSuiteName: "Write values to a CSV file2",
        projectName: "Write values to a CSV file with Sample Test Data.2",
    ...
    {
        testSuiteName: "Upload image through CSV2",
        projectName: "Upload images and descriptions with Sample Test Data.2",
    ...
    {
        testSuiteName: "Append new rows to a CSV file2",
        projectName: "Append new rows to a CSV file with Sample Test Data.2",
    ...
    {
        testSuiteName: "Upload multiple files with drag and drop2",
        projectName: "Upload multiple files with drag and drop.2",
